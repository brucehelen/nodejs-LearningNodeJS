...
// 请求命令模板
// curl -s -X POST -H "Content-Type:application/json" -d '{"album_name": "new_album_name1"}' http://localhost:8080/albums/new_album_name/rename.json
...
function handle_incoming_request(req, res) {
    ...
    } else if (core_url.substr(-12)  == '/rename.json'
